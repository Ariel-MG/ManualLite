...
- **CAP-4**
  ...
  - **success:** Un manual con al menos un `kind: section` y acciones antes de la primera sección no inventa numeración; el export falla con el mensaje `hay pasos fuera de toda sección` y no produce archivo. El autor las acomoda en el editor. Notas y reglas antes de la primera sección no disparan el error.
